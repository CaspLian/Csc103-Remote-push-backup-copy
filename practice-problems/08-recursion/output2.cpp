...
int main()
{
	 ...
	 * fit in a size_t!  For your amusement, images/output2.svg has
	 * the call graph for f(3,2).  If curious, you can find the code
	 * I used to make it in the traces/ directory. */
	return 0;
}
